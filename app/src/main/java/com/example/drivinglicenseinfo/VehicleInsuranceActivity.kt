...
import com.example.drivinglicenseinfo.databinding.ActivityVehicleInsuranceBinding
import java.util.Locale

class VehicleInsuranceActivity : AppCompatActivity() {
    private lateinit var binding: ActivityVehicleInsuranceBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityVehicleInsuranceBinding.inflate(layoutInflater)
